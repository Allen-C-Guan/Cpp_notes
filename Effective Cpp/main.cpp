 ...
 * 变成一个wrapper。但是流程的某些步骤的具体实现确是通过private virtual function的
 * 多态来实现的！
 *
 ...
 *
 * 这两个优点，virtual是无法实现的，因为virtual与类型绑定，而成员确是个体维度绑定的！
 *
...
//    GameCharacterFunctional g4(std::bind(&GameCharacterFunctional::healthVal, &g4, std::placeholders::_1));
