//
// Created by Allen on 2021/7/7.
//

#ifndef EFFECTIVE_CPP_PUBLIC_AND_IS_A_H
#define EFFECTIVE_CPP_PUBLIC_AND_IS_A_H
#include <iostream>
#include <string>
#include <memory>
#include <vector>
 ...
 *
 * 这主要是因为代码中的语义中的public强调的Derived总可以在任何地方替代Base，换句话说，
 * 是施加于base上的每一件事情，必须都可以施加在Derived上，但是我们生活中的分类标准并不总是这个标准的！
 *
 */
int main()
{
...
#endif //EFFECTIVE_CPP_PUBLIC_AND_IS_A_H
